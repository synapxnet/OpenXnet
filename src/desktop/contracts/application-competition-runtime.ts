...
export function parseCreateApplicationCompetitionIncidentRequest(
  ...
  requireFields(value, ["workspaceId", "title", "summary", "severity", "actorId", "scenario"], "Competition incident request");
...
export function parseDecideApplicationCompetitionApprovalRequest(
  ...
  requireFields(value, ["approvalId", "decision", "actorId", "reason"], "Competition approval decision");
  return {
