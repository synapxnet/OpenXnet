...
<div align="center">
  ...
  <a href="https://temporal-lantern-7e8.notion.site/openxnet-211b2b2cb6f180c899d1c27a98c4965d"><img src="https://img.shields.io/badge/English%20Guide-Notion-000000?style=for-the-badge&logo=notion"/></a>
...
### Windows portable package (Recommended! Installation-free source version, support one-click synchronization to the latest version of the warehouse, no need to wait for the desktop version to be packaged)
  ...
  👉 [Click to download](https://github.com/heshengtao/openxnet/releases/download/v0.3.8/openxnet-win-v0.3.8.7z)
  👉 [中国用户点击下载](https://modelscope.cn/models/ailm32442/openxnet-portable/resolve/master/v0.3.8-hot-fix/openxnet-win-v0.3.8.7z)
...
### Windows Desktop Installation
  ...
  👉 [Click to download](https://github.com/heshengtao/openxnet/releases/download/v0.3.8/Super-Agent-Party-Setup-0.3.8.exe)
  👉 [中国用户点击下载](https://modelscope.cn/models/ailm32442/openxnet-portable/resolve/master/v0.3.8-hot-fix/Super-Agent-Party-Setup-0.3.8.exe)
...
### macOS portable package (Currently only M chips are supported, developer-oriented, no-install source version, one-click sync to latest repo, no need to wait for desktop build)
  ...
  👉 [Click to download](https://github.com/heshengtao/openxnet/releases/download/v0.3.8/openxnet-mac-v0.3.8.7z)
  👉 [中国用户点击下载](https://modelscope.cn/models/ailm32442/openxnet-portable/resolve/master/v0.3.8-hot-fix/openxnet-mac-v0.3.8.7z)
...
### MacOS Desktop Installation (Currently only M chips are supported.)
  ...
  👉 [Click to download](https://github.com/heshengtao/openxnet/releases/download/v0.3.8/Super-Agent-Party-0.3.8-Mac.dmg)
  👉 [中国用户点击下载](https://modelscope.cn/models/ailm32442/openxnet-portable/resolve/master/v0.3.8-hot-fix/Super-Agent-Party-0.3.8-Mac.dmg)
...
`.AppImage` is a Linux application format that does not require installation and can be used immediately. Suitable for most Linux distributions.
  ...
  👉 [Click to download](https://github.com/heshengtao/openxnet/releases/download/v0.3.8/Super-Agent-Party-0.3.8-Linux.AppImage)

#### 2. Install using `.deb` package (Suitable for Ubuntu/Debian systems)

  👉 [Click to download](https://github.com/heshengtao/openxnet/releases/download/v0.3.8/Super-Agent-Party-0.3.8-Linux.deb)
...
- Two commands to install this project:
  ```shell
  docker pull ailm32442/openxnet:latest
  docker run -d -p 3456:3456 -v ./super-agent-data:/app/data ailm32442/openxnet:latest
  ```
...
- Install the project:
  ...
  ```shell
  git clone https://github.com/heshengtao/openxnet.git
  cd openxnet
  docker-compose up -d
  ```
...
👉 [SAP-lite-Windows-exe](https://github.com/heshengtao/desktop-for-sap/releases/download/v0.1.2/openxnet-lite-Setup-0.1.2.exe)

👉 [SAP-lite-MacOS-dmg](https://github.com/heshengtao/desktop-for-sap/releases/download/v0.1.2/openxnet-lite-0.1.2-Mac.dmg)
...
Added a brand-new extension system. You can check available plugins at [plugins list](https://openxnet.github.io/plugins.html), or directly view and install them in the party under 【Developer】->【Extensions】. You can also add your own developed extensions to the official plugin list at [openxnet.github.io](https://github.com/openxnet/openxnet.github.io)! 

### Existing Extension

| Name                  | Author            | Description                                                        | Repository URL                                   |
|-----------------------|-------------------|--------------------------------------------------------------------|--------------------------------------------------|
| OpenXnet Example | heshengtao        | Example plugin for OpenXnet, demonstrating plugin architecture and capabilities. | https://github.com/heshengtao/sap-example        |
| OpenXnet Example With NodeJS | heshengtao        | This is a chat frontend example with nodeJS environment | https://github.com/heshengtao/sap-example-with-node        |
| Web Preview           | heshengtao        | A plugin enabling web previewing functionality for OpenXnet. | https://github.com/heshengtao/sap-web-preview    |
...
| AI RSS reader      | heshengtao  | This is an AI RSS reader extension for the OpenXnet      | https://github.com/heshengtao/sap-rss  |
| Remote      | heshengtao  | One-click expose OpenXnet to the public internet             | https://github.com/heshengtao/sap-remote  |
| Code Server      | heshengtao  | IDE extension for OpenXnet          | https://github.com/heshengtao/sap-code-server  |
...
- API call: Developer-friendly, perfectly compatible with OpenAI format, can output in real-time, and does not affect the original API's response speed. No need to modify the calling code:
  ...
  response = client.chat.completions.create(
    model="super-model",
    messages=[
        {"role": "user", "content": "What is OpenXnet?"}
    ]
  )
...
Please refer to the following document for the main functions:
  ...
  - 👉 [English document](https://temporal-lantern-7e8.notion.site/openxnet-211b2b2cb6f180c899d1c27a98c4965d)
...
| Extension System | You can check out the available plugins in the [Extension List](https://openxnet.github.io/plugins.html). You can also view and install plugins directly in Party by navigating to 【Developer】 -> 【Extensions】. You can add your own developed extensions to the official extension list at [openxnet.github.io](https://github.com/openxnet/openxnet.github.io)! |
...
<a href="https://github.com/heshengtao/openxnet/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=heshengtao/openxnet" />
</a>

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=heshengtao/openxnet&type=Date)](https://www.star-history.com/#heshengtao/openxnet&Date)
